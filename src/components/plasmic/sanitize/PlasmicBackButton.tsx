...
import sty from "./PlasmicBackButton.module.css"; // plasmic-import: kESr-Yy47Y/css

import backIconpngRaVbSfEPf from "./images/backIconpng.png"; // plasmic-import: raVBSfEPf/picture
