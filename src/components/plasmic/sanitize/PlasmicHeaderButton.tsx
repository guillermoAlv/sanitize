...
import sty from "./PlasmicHeaderButton.module.css"; // plasmic-import: TWvCE0iU4R/css
...
function PlasmicHeaderButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box__i25V9)}>
        <div className={classNames(defaultcss.all, sty.box__g3UyU)}>
          <p.PlasmicSlot
