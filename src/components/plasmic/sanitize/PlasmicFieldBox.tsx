...
import sty from "./PlasmicFieldBox.module.css"; // plasmic-import: 4M9KjaViuS/css
...
function PlasmicFieldBox__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box___9FYh6)}>
        <div
      ...
      <div className={classNames(defaultcss.all, sty.box__xnant)}>
